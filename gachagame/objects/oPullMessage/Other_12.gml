/// @description 5* message

randomise();

var pull = irandom(array_length(con_client.five_star_list)-1)

var obj_pull = con_client.five_star_list[pull]

var new_pull = instance_create_layer(x+64, y+64, layer, obj_pull)

text = "You rolled a 5* " + con_client.five_star_list[pull].char_name
